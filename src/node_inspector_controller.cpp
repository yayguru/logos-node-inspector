...
QVariantMap toVariantMap(const inspector::HostStatus& host)
{
    return {
        ...
        { QStringLiteral("diskTotalBytes"), host.diskTotalBytes },
        { QStringLiteral("diskUsedBytes"), host.diskUsedBytes },
        { QStringLiteral("diskAvailableBytes"), host.diskAvailableBytes },
        { QStringLiteral("diskUsedPercent"), host.diskUsedPercent },
        { QStringLiteral("hasMemory"), host.hasMemory },
        { QStringLiteral("memoryTotalBytes"), host.memoryTotalBytes },
        { QStringLiteral("memoryUsedBytes"), host.memoryUsedBytes },
        { QStringLiteral("memoryFreeBytes"), host.memoryFreeBytes },
        { QStringLiteral("memoryAvailableBytes"), host.memoryAvailableBytes },
...
QVariantMap toVariantMap(const inspector::LogosStatus& logos)
{
    return {
        ...
        { QStringLiteral("nPeers"), logos.nPeers },
        { QStringLiteral("nConnections"), logos.nConnections },
        { QStringLiteral("nPendingConnections"), logos.nPendingConnections },
        { QStringLiteral("mode"), toQString(logos.mode) },
        { QStringLiteral("height"), logos.height },
        { QStringLiteral("slot"), logos.slot },
